...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    firstController *first = [[firstController alloc] initWithNibName:nil bundle:nil];
    UINavigationController *firstNavigationController =
    [[UINavigationController alloc] initWithRootViewController:first ];
    
    secondController *second = [[secondController alloc] initWithNibName:nil bundle:nil];
    ...
    [tabBar setViewControllers:@[firstNavigationController,secondNavigationController]];
